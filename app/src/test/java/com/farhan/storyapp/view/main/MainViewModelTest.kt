...
import com.farhan.storyapp.MainDispatcherRule
...
class MainViewModelTest{
    ...
    @Before
    fun setup() {
        mainViewModel = MainViewModel(userRepository, repositoryStory)
    }
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(repositoryStory.getStories("token")).thenReturn(expectedStory)
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        Mockito.`when`(repositoryStory.getStories("token")).thenReturn(expectedQuote)
